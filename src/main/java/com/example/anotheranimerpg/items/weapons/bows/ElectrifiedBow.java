...
public class ElectrifiedBow extends CustomBow {

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        if (Screen.hasShiftDown()) {
            pTooltipComponents.add(new TextComponent("§eA bow infused by electricity"));
        } else {
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!world.isClientSide) {
                        ...
                        abstractarrow = new CustomArrow(world, player, ModEffects.ELECTROCUTE.get(), 40, 0, true, 3);
